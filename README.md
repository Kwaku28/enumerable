...
**[Enumerable]** is an application used for sorting out list of items.
...
```sh
  cd my-folder
  git clone https://github.com/Kwaku28/enumerable.git
```
...
Feel free to check the [issues page](https://github.com/Kwaku28/enumerable/issues).
